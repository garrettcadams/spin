<?php
    /*
    Plugin Name: CTL Arcade - Slot Ramses
    Plugin URI: http://www.codethislab.com/
    Description: Slot Ramses for CTL Arcade Wordpress Plugin.
    Version: 1.0
    Author: 20script
    ...
    */
    ...
    class CTLArcadeSlotRamses {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-slot-ramses";
        private $_szPluginName              = "Slot Ramses";
        private $_szAspectRatio             = "7:3";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "bonus, bonus game, casino, egypt, gambling, html5 slot machine, instant win, money, poker, slot, slot machine, sweepstakes, videopoker, win";
    ...
    $g_oCTLArcadeSlotRamses =  new CTLArcadeSlotRamses();
